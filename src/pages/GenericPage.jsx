    ...
    <>
      <section className="bg-paper border-b border-line">
        <Container className="py-14 sm:py-20">
          <p className="text-sm font-semibold text-gold-dark mb-3">{content.eyebrow}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2 prose-content">
              ...
              <p className="text-ink-soft leading-relaxed">
                This page is a placeholder built from AVCA's real site structure so every menu
                item resolves to a working page. Swap this block for the section's actual copy,
                imagery and any listing or detail components it needs (e.g. a filterable grid for
                News & Insights, or a profile grid for the Team page).
              </p>
              <p className="text-ink-soft leading-relaxed mt-4">
                ...
                design system in one place — colors, type, spacing — updates every page
                consistently.
              </p>
            </div>
            <aside className="border border-line p-6 h-fit">
              <h2 className="font-display text-lg text-ink mb-3">Need something specific?</h2>
              <p className="text-sm text-ink-soft leading-relaxed mb-4">
                Get in touch with the team for membership, media or partnership enquiries.
              </p>
